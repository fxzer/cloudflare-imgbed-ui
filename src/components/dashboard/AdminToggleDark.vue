...
#themeToggle {
  ...
  width: var(--theme-toggle-size, 36px);
  height: var(--theme-toggle-size, 36px);
  padding: 0;
  border-radius: var(--theme-toggle-radius, 10px);
  background: var(--theme-toggle-control-bg, var(--flat-surface));
...
#themeToggle:hover {
  ...
  background: var(--flat-surface-soft, var(--flat-surface));
}
